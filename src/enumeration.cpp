...
void profile_enumerate_epr(double** mu, double *b, double* Rvec, int n, vec_RR& result) {
...
void enumerate_epr(double** mu, double *b, double* Rvec, int n, vec_RR& result, unsigned long &termination, double &time) {
	...
	// C++ uses processor (float) precision even when comparing doubles 
...
void enumerate_epr(double** mu, double *b, double* Rvec, int n, vec_RR& result) {
	...
	return enumerate_epr(mu, b, Rvec, n, result, termination, time); 
}
