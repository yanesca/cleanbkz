...
#gnuplot -p -e "set terminal pdf;set output '$filename.pdf';set yrange [1:*];set logscale y; plot '$1' i 0 u 1:2 w lines title columnheader(1), '$1' i 1 u 1:2 w lines title columnheader(1)"
